<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="index.aspx.cs"
  ...
  <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <main>
          ...
          <div class="hero-carousel-grid__item">
            ...
            <div class="bg-video">
              <video class="bg-video__content" autoplay="" muted="" loop="">
                ...
                <!-- <source src="video/bg-video.mp4" type="video/webm"> -->
                Sorry your browser does not supported!
              </video>
            </div>
          </div>
          <div class="hero-carousel-grid__item">
              ...
              <form>
                <div class="mb-3">
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                    ControlToValidate="txtName" ValidationGroup="A" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
                <div class="mb-3">

                  <asp:TextBox ID="txtEmail" runat="server" class="form-control" placeholder="Email"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*"
                    ControlToValidate="txtEmail" ValidationGroup="A" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
                <div class="mb-3">
                  <label class="interseted">You are interested in</label>
                  <div class="form-check">
                    <asp:CheckBoxList ID="chkInterest" runat="server">
                      <asp:ListItem>Implementing ALfA pilot</asp:ListItem>
                      <asp:ListItem>Replicating ALfA toolkits</asp:ListItem>
                      <asp:ListItem>Receiving training</asp:ListItem>
                      <asp:ListItem>Volunteering/internship</asp:ListItem>
                      <asp:ListItem>Ordering Learning Materials</asp:ListItem>
                  ...
                  <div class="mb-3">
                    ...
                    <asp:TextBox ID="txtMess" runat="server" rows="5" placeholder="Message" class="form-control"
                      TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*"
                      ControlToValidate="txtMess" ValidationGroup="A" ForeColor="Red"></asp:RequiredFieldValidator>
                  </div>
                  <div class="link-one">

                    <asp:Button ID="Button1" runat="server" Text="Submit" class="btn-2" ValidationGroup="A"
      ...
      <section class="rajnath-singh mt-large">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-5 col-md-12">
              <h2 class="secondary-heading">Shri Rajnath Singh, Defence Minister, India, in support of ALfA Accelerating
                Learning for All</h2>
              <div class="space-three"></div>
              <div class="content-para">
                <p>Shri Rajnath Singh, Defence Minister, India and Former Minister of Education, Uttar Pradesh (most
                  populous state of
                  India), in support of ALfA Accelerating Learning for All.</p>
              </div>
            </div>
            <div class="col-lg-7 col-md-12">
              <!-- Button trigger modal -->
              <div class="r-video" data-bs-toggle="modal" data-bs-target="#exampleModal">
                <img src="img/rajnath-01.jpg" alt="" class="img-fluid">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <iframe width="100%" height="100%"
                        src="https://www.youtube.com/embed/AdtQFb4GkYc?si=Td9P75GgAr-CG08P" title="YouTube video player"
                        frameborder="0"
      ...
      <section class="upcoming mt-large">
        <div class="container">
          <h5 class="card-title" style="color: #11823b; text-align: center;">Want to be part of the
            transformation of education?</h5>
          <h2 class="secondary-heading text-center"><span
              style="font: inherit!important; font-weight: normal!important;">Join us at
              an</span> UPCOMING EVENT</h2>
          ...
          <div class="row align-items-center">
                ...
                <div class="card-body">
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12 last">
                      <span class="online">On Demand Basis</span>
                    </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <img src="img/wlc-002.jpg" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
              <h2 class="secondary-heading">Our Audacious Vision <span style="text-transform: none;display: block;">A
                  World Where Every Child and Adult Knows How to Read</span>
              </h2>
              <div class="space-one"></div>
              <div class="content-para">
                <p>Accelerating Learning for All (ALfA) unlocks the power of paired learning, fun activities, and a
                  known-to-unknown pedagogy to enable
                  children and adults
      ...
      <section class="our-projects mt-large">
        <div class="container">
          <h2 class="secondary-heading text-center text-white">Meet the Changemakers</h2>
          <div class="space-one"></div>
          <div class="row">
      ...
      <section class="our-partners">
        <div class="container">
          <h2 class="secondary-heading text-center">20+ Partners and Counting</h2>
          <h5 class="card-title" style="color: #11823b; text-align: center;">Join us in a learning revolution</h5>
          <div class="space-one"></div>
      ...
      <section class="googl-mp mb-large">
        <div class="container">
          <h2 class="secondary-heading text-center">available in 30+ languages</h2>
